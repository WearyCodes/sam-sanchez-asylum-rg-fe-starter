...
1.  if user's status is loggedIn, logout button shows on navigation || other way

2.  Set up auth0. using the tutorial thing (returns login status)

3.  New component file for "profile page"
